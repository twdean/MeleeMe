...
namespace TweetinCore.Interfaces
{
    ...
    public interface IUser : ITwitterObject, IEquatable<IUser>
    {
        ...
        List<long> GetFriendsIds(bool createUserList = false, long cursor = 0);
        ...
        /// <param name="cursor">Cursor for iteration</param>
        /// <returns>List of Friends Ids</returns>
        List<long> GetFriendsIds(IToken token, bool createUserList = false, long cursor = 0);
        ...
        List<long> GetFollowers(bool createFollowerList = false, long cursor = 0);
        ...
        /// <param name="cursor">Cursor for iteration</param>
        /// <returns>List of Followers Ids</returns>
        List<long> GetFollowers(IToken token, bool createFollowerList = false, long cursor = 0);
