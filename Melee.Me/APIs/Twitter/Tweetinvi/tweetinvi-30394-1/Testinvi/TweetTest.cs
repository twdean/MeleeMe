    ...
    public class TweetTest
    {
        ...
        public void Tweet_ConstructorAndPopulate1()
        {
            ...
            try
            {
                ...
                tweet.PopulateTweet(TokenSingleton.Instance);
            }
            catch (Exception wex)
            {
        ...
        public void Tweet_ConstructorAndPopulate2()
        {
            ...
            try
            {
                ...
                var noTweet = new Tweet(-1, TokenSingleton.Instance);
        ...
        public void Tweet_PublishTweet2()
        {
            ...
            // Send the Tweet
            tweet.Publish(TokenSingleton.Instance);
        ...
        public void Tweet_PublishTweetWithGeo1()
        {
            ...
            // Send the Tweet
            tweet.PublishWithGeo(latitude, longitude, true, TokenSingleton.Instance);
        ...
        public void GetRetweets_403_AfterReRetweet()
        {
            ...
            if (tweets.Count != 0)
            {
                ...
                Thread.Sleep(10000);
                ITweet t2 = new Tweet(t.Id, TokenSingleton.Instance);
